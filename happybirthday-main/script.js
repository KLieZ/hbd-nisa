const animationTimeline = () => {
    // Split chars that needs to be individually
    ...
    .straggerFromTo('.baloons img', 2.5, {
        opacity: 0,
        y: 1400
    }, {
        opacity: 1,
    ...
    .straggerFrom('.wish__hbd span', 0.7, {
        opacity: 0,
        y: -50,
        rotation: 150,
        skewX: '30deg',
    ...
    .straggerFromTo('.wish__hbd span', 0.7, {
        scale:1.4,
        rotateY: 150
    }, {
        scale:1,
    ...
    .form('.nine p', 1, ideaTextTrans, 1.2)
    .to('.last__smile', 0.5, {
